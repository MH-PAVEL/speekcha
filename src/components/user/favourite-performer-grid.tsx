...
const FavouritePerformerGrid = ({
  ...
  const renderFlag = (country: string) => {
    ...
    return (
      pCountry && (
        <span className="performer-flag">
          <img alt="" src={pCountry.flag} />
        </span>
      )
    );
  };
          ...
          >
            ...
            >
              <a className="performer-avatar">
                <img
                  src={favourite.performer?.avatar || placeholderAvatarUrl}
                  alt=""
                />
              </a>
            </Link>
            <div className="performer-title">
              ...
              {favourite.performer?.dateOfBirth && (
                <span>({getAge(favourite.performer?.dateOfBirth)})</span>
              )}
            ...
            <Popconfirm
              placement="bottom"
              title={t('Are you sure to dislike this performer')}
