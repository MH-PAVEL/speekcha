        ...
        (typeof commission === 'number' ? (
          <Row>
            <Col xs={24} sm={6}>
              <Card
                {...style}
                title={<span>{t('Commission')}</span>}
                extra={<span style={{ color: '#ff0066' }}>{commission}%</span>}
              >
                {t(
                  'When a member spends paid tokens with you, you will get this commission'
                )}
              </Card>
            </Col>
          </Row>
