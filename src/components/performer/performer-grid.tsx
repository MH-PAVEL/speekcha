...
const renderTags = (tags: string[], t: any) => (
    ...
    <Card.Grid className={className} key={performer._id} hoverable={false}>
        ...
        <a>
          <div className="performer-avatar">
            <img
              ...
              alt=""
            />
            <span className={statusClassNames.join(' ')}>{t(status)}</span>
      ...
      <div className="performer-bottom">
        <Row justify="space-between">
          <Col>
            <div>{performer.tags && renderTags(performer.tags, t)}</div>
          </Col>
          <Col>
            <div
              aria-hidden
        ...
        <div className="about-me">{t(performer?.aboutMe)}</div>
      </div>
    </Card.Grid>
  );
};
      ...
      >
        ...
        {success &&
          ...
          (total > 0 ? (
            ...
            <div className="ant-card-head">{t('No model found')}.</div>
          ))}
      </Card>
