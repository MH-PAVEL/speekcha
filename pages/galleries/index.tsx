              ...
              >
                <Row gutter={20}>
                  {ids && ids.length > 0 ? (
                    ...
                    <p className="no-items-found">{t('No gallery found')}.</p>
                  )}
                </Row>
              </InfiniteScroll>
            ) : (
...
export default withRouter(
  connect(mapStates, mapDispatchs)(withTranslation('common')(GalleriesPage))
);
