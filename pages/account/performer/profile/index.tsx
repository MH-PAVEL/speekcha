...
class PerformerProfilePage extends PureComponent<P> {
  ...
  componentDidUpdate(prevProps: P) {
    ...
    if (updateSuccess && prevProps.updateSuccess !== updateSuccess) {
      message.success(this.props.t('Update Profile Success.'));
    }
  ...
  render() {
    const { action, performer, categoriesData, updating, countries, t } =
      this.props;
    const uploadHeaders = {
    ...
    return (
      <>
        ...
        <div className="performer-profile-page">
          ...
          >
            <Tabs.TabPane tab={t('Profile Image')} key="profile-image">
              <Form.Item label={t('Profile Image')}>
                <ImageUpload
            ...
            <Tabs.TabPane tab={t('My Profile')} key="profile">
              <PerformerProfile performer={performer} />
            </Tabs.TabPane>
            <Tabs.TabPane tab={t('Edit Profile')} key="edit-profile">
              <ProfileEditForm
                {...performer}
...
export default connect(
  mapStateToProps,
  mapDispatchs
)(withTranslation('common')(PerformerProfilePage));
