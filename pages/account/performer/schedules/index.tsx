...
class PerformerProfilePage extends PureComponent<IProps, IStates> {
  ...
  render() {
    const { action, performer, updating, t } = this.props;
    ...
    return (
      <>
        ...
        <div className="performer-schedule-page">
          ...
          >
            <Tabs.TabPane tab={t('Schedules')} key="schedules">
              <Row>
                <Col sm={{ span: 12 }} xs={{ span: 24 }}>
                  <List itemLayout="horizontal">
                    ...
                    {Object.keys(schedule).map((key) => (
                      <ListItem
                        title={t(
                          formatDate(moment().day(key).toDate(), 'dddd')
                        )}
                        description={
                          !schedule[key].closed &&
            ...
            <Tabs.TabPane tab={t('Edit Schedule Details')} key="edit-schedules">
