    ...
    return (
      <>
        ...
        <div className="payout-request-page">
          <PageHeader title={t('Payout Request')} />
          <div className="ant-page-header">
            <Button
              type="primary"
              onClick={() =>
                Router.push('/account/performer/payout-requests/create')
              }
            >
              {t('Create new Payout Request')}
            </Button>
          </div>
          <PayoutRequestList
            payouts={data}
...
export default connect(
  mapStateToProps,
  mapDispatch
)(withTranslation('common')(PerformerPayoutRequestPage));
