...
class PerformerVideosPage extends PureComponent<IProps, IStates> {
  ...
  async addVideos() {
    ...
    try {
      ...
      offset = limit + offset;
      const resp: IResponse<IDataResponse<IVideo>> =
      ...
      <>
        ...
        <div className="performer-videos-page">
          ...
          <VideoGrid
            ...
            title=""
            onViewVideo={(video: IVideo) =>
              this.ref.showModalBuyAssets(video.video.url || '')
            }
          />
          <PopupVideoDetail t={t} ref={(ref) => (this.ref = ref)} />
        </div>
      </>
    );
  }
...
export default connect(
  mapStateToProps,
  mapDispatch
)(withTranslation('common')(PerformerVideosPage));
