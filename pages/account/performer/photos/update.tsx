  ...
  async onFinish(data) {
    ...
    try {
      ...
      await photoService.update(
        `/performer/performer-assets/photos/${photo._id}`,
        {
          ...data,
          performerId: performer._id
        }
      );
      message.success(this.props.t('Update photo success.'));
      Router.back();
    } catch (e) {
    ...
    return (
      <>
        ...
        <div className="performer-photos-page">
          <PageHeader title={t('Update a Photo')} />
          <PhotoForm
            loading={onSubmit}
...
export default connect(mapStateToProps)(
  withTranslation('common')(UpdatePerformerPhotoPage)
);
